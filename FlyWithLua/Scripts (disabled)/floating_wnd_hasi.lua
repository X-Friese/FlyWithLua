...
function hasi_on_draw(hasi_wnd, x, y)
...
function hasi_on_close(hasi_wnd)
end

-- width, height, decoration style as per XPLMCreateWindowEx. 1 for solid background, 3 for transparent
local hasi_wnd = float_wnd_create(640, 480, 1, false)
float_wnd_set_title(hasi_wnd, "HASI for Floating Windows")
float_wnd_set_ondraw(hasi_wnd, "hasi_on_draw")
float_wnd_set_onclick(hasi_wnd, "hasi_on_click")
float_wnd_set_onclose(hasi_wnd, "hasi_on_close")
