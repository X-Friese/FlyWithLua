...
float_wnd_set_title(demo_floating_wnd, "floating window Demo SCREEN_HEIGHT")
...
-- We next find the SCREEN_HEIGHT and divide it by 2 then subtract the window heigth divided by 2.
float_wnd_set_position(demo_floating_wnd, SCREEN_WIDTH / 2 - 640 / 2, SCREEN_HEIGHT / 2 - 480 / 2)
-- The first parameter must be a handle to a window previously created with float_wnd_create and the
