...
// This is how you can add manual additions because Perl script did not provide so shows how you could add functions manualy
// It is best to have the perl script find all of these but to get this update moving I will do this.
// It is very important that imgui_lua_bindings.cpp the matching functions here.
...
//    IMGUI_API void  AddImage(ImTextureID user_texture_id, const ImVec2& p_min, const ImVec2& p_max, const ImVec2& uv_min = ImVec2 0  0, const ImVec2& uv_max = ImVec2 1  1, ImU32 col = IM_COL32_WHITE);
// Unsupported arg type ImTextureRef tex_ref
...
OPTIONAL_NUMBER_ARG(thickness, 1.0f)
OPTIONAL_ENUM_ARG(flags, ImDrawFlags, 0)
DRAW_LIST_CALL_FUNCTION_NO_RET(AddRect, p_min, p_max, col, rounding, thickness, flags)
END_IMGUI_FUNC
