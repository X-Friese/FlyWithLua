...
START_ENUM(Flags)
//    ImDrawFlags_None                        = 0,
MAKE_ENUM(ImDrawFlags_None,None)
//    ImDrawFlags_Closed                      = 1 << 0, // PathStroke(), AddPolyline(): specify that shape should be closed (Important: this is always == 1 for legacy reason)
MAKE_ENUM(ImDrawFlags_Closed,Closed)
//    ImDrawFlags_RoundCornersTopLeft         = 1 << 4, // AddRect(), AddRectFilled(), PathRect(): enable rounding top-left corner only (when rounding > 0.0f, we default to all corners). Was 0x01.
MAKE_ENUM(ImDrawFlags_RoundCornersTopLeft,RoundCornersTopLeft)
//    ImDrawFlags_RoundCornersTopRight        = 1 << 5, // AddRect(), AddRectFilled(), PathRect(): enable rounding top-right corner only (when rounding > 0.0f, we default to all corners). Was 0x02.
MAKE_ENUM(ImDrawFlags_RoundCornersTopRight,RoundCornersTopRight)
//    ImDrawFlags_RoundCornersBottomLeft      = 1 << 6, // AddRect(), AddRectFilled(), PathRect(): enable rounding bottom-left corner only (when rounding > 0.0f, we default to all corners). Was 0x04.
MAKE_ENUM(ImDrawFlags_RoundCornersBottomLeft,RoundCornersBottomLeft)
//    ImDrawFlags_RoundCornersBottomRight     = 1 << 7, // AddRect(), AddRectFilled(), PathRect(): enable rounding bottom-right corner only (when rounding > 0.0f, we default to all corners). Wax 0x08.
MAKE_ENUM(ImDrawFlags_RoundCornersBottomRight,RoundCornersBottomRight)
//    ImDrawFlags_RoundCornersNone            = 1 << 8, // AddRect(), AddRectFilled(), PathRect(): disable rounding on all corners (when rounding > 0.0f). This is NOT zero, NOT an implicit flag!
MAKE_ENUM(ImDrawFlags_RoundCornersNone,RoundCornersNone)
//    ImDrawFlags_RoundCornersTop             = ImDrawFlags_RoundCornersTopLeft | ImDrawFlags_RoundCornersTopRight,
MAKE_ENUM(ImDrawFlags_RoundCornersTop,RoundCornersTop)
//    ImDrawFlags_RoundCornersBottom          = ImDrawFlags_RoundCornersBottomLeft | ImDrawFlags_RoundCornersBottomRight,
MAKE_ENUM(ImDrawFlags_RoundCornersBottom,RoundCornersBottom)
//    ImDrawFlags_RoundCornersLeft            = ImDrawFlags_RoundCornersBottomLeft | ImDrawFlags_RoundCornersTopLeft,
MAKE_ENUM(ImDrawFlags_RoundCornersLeft,RoundCornersLeft)
//    ImDrawFlags_RoundCornersRight           = ImDrawFlags_RoundCornersBottomRight | ImDrawFlags_RoundCornersTopRight,
MAKE_ENUM(ImDrawFlags_RoundCornersRight,RoundCornersRight)
//    ImDrawFlags_RoundCornersAll             = ImDrawFlags_RoundCornersTopLeft | ImDrawFlags_RoundCornersTopRight | ImDrawFlags_RoundCornersBottomLeft | ImDrawFlags_RoundCornersBottomRight,
MAKE_ENUM(ImDrawFlags_RoundCornersAll,RoundCornersAll)
END_ENUM(Flags)
...
MAKE_ENUM(ImDrawListFlags_AntiAliasedLinesUseTex,AntiAliasedLinesUseTex)
...
MAKE_ENUM(ImFontAtlasFlags_NoBakedLines,NoBakedLines)
END_ENUM(AtlasFlags)
//struct ImFontAtlas
